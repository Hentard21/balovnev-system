...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "На тарифе «Абсолютный Чемпион» у тебя прямой закрытый чат с Игорем: ответы на вопросы — в течение рабочего дня, разборы видео техники — в течение 1–2 дней. Это личное ведение, а не автоответы ассистентов.",
  },
];
